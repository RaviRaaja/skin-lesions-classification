...
modelCheckpoint=ModelCheckpoint('/home/stan/Desktop/Melanoma_local/best_butterResnet_38_{epoch}.hdf5', monitor='val_loss', verbose=0, save_best_only=False, save_weights_only=True, mode='auto',period=10)
def scheduler(epoch):
    if epoch<150:
        return 0.0001
    elif epoch<200:
...
path = '/home/stan/Desktop/Melanoma_local/with_out_aug_70_30/train'
...
path = '/home/stan/Desktop/Melanoma_local/with_out_aug_70_30/dev'
